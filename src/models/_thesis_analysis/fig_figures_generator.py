...
class ThesisLatexFigures:
    ...
    def create_promotion_by_period_figure(self, save_path='figures/promotion_by_period.png'):
        ...
        if self.evolution_data is None:
            print("No data loaded for promotion by period figure")
            return
    ...
    def create_confidence_lineplot_figure(self, save_path='figures/confidence_lineplot.png'):
        ...
        """
        if self.evolution_data is None:
            print("No data loaded for confidence lineplot")
            return
    ...
    def create_confidence_boxplot_figure(self, save_path='figures/confidence_boxplot.png'):
        ...
        """
        if self.evolution_data is None:
            print("No data loaded for confidence boxplot")
            return
    ...
    def generate_latex_section_text(self):
        ...
        if self.evolution_data is None:
            print("No data loaded for LaTeX text generation")
            return
...
This section examines the evolution of the promotional strategy across four analysis periods: 2022-H1, 2022-H2, 2023-H1, and 2023-H2. The goal is to assess whether the Random Forest classifier exhibited temporal adaptability in terms of promotion targeting and model confidence.
...
\\end{{figure}}"""
    ...
    def generate_all_thesis_figures(self):
        ...
        try:
            ...
            print(f"Figure generation encountered an error: {e}")
            import traceback
            traceback.print_exc()

def main():
    """Execute comprehensive thesis figure generation."""
