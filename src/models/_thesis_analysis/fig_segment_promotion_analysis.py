...
class SimpleSegmentAnalysis:
    ...
    def create_thesis_table(self, crosstab_pct):
        ...
        # Select primary columns for academic analysis
        main_columns = ['NO_PROMOTION', 'GROWTH_TARGET', 'INTERVENTION_NEEDED']
        
        # Validate and filter available columns
        ...
        if available_columns:
            ...
            # Use first 3 available promotion columns
    ...
    def export_results(self, crosstab_pct, crosstab_counts, thesis_table):
        ...
        with open(summary_file, 'w') as f:
            ...
            f.write("• Casual customers: Primarily require no promotion (stable satisfaction)\n")
            ...
            f.write("• Demonstrates system's ability to adapt targeting by customer segment\n")
    ...
    def execute_analysis(self):
        ...
        try:
            ...
            if not self.load_csv_predictions():
                print("Unable to load prediction data")
                return
            
            # Create segments
            if not self.create_simulated_segments():
                print("Unable to create customer segments")
                return
...
def main():
    """Execute comprehensive segment-promotion analysis."""
